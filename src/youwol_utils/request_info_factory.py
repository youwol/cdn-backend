...
class PutAssetGtwAssetOptions(PatternRequestInfoExtractor):
    pattern = 'OPTIONS:/api/assets-gateway/assets/*/location/**'

    def extract_from_pattern(self, substitutes):
        [kind, _] = substitutes
        return RequestInfo(message="OPTION preflight: create asset", attributes={'kind': kind})
